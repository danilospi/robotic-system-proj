...
# Questo controllo in posizione con profilo di velocità include anche le formule che permettono di passare da coordinate cartesiane a coodinate polari
class SpeedProfileGenerator2D:
    ...
    def evaluate(self, delta_t, current_pos, angle_constraint):
        ...
        #Eseguo la conversione Cartesian to Polar
